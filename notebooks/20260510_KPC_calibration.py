...
CHROMA_TAU_REF_NS  = 0.960          # chromablue reference lifetime (ns)
                                    # range observed: 0.80-1.10 ns with urea IRF;
                                    # 1.000 ns -> urea at (1.004, 0.021)
                                    # 0.980 ns -> urea at (1.007, 0.013)
                                    # trying 0.960 ns to bring S closer to 0
